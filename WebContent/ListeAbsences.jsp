...
<h2>Afficher la liste des absences</h2>

<form action="AfficherEtudiantAbs1" method="post">
				 <table class="table table-striped">
 		 	 <tr>		
 		 				
					<td>Filière :<input class=" form-control" type ="text" name="fil"></td>
					<td>Groupe:<input  class=" form-control"type ="text" name="group"><td>
					<td>Année Scolaire : <input class=" form-control" type ="text" name="asc"><td>
				...
				<tr>
				<th>Nom</th><th>Prénom</th><th>Date</th><th>Edit</th><th>Delete</th>
				</tr>
				<c:forEach items="${modele.etudiantAbs}" var="e" >
				<tr>
					<td>${e.id_a}</td>
					<td>${e.nom} </td>
					<td>${e.prenom} </td>
					<td>${e.date}</td>
					<td><button class="btn btn-primary btn-xs" onclick="window.location.href='editform.jsp?id=${u.getId_a()}'" ><i class="fa fa-pencil"></i></button>
					</td>
					<td><button class="btn btn-danger btn-xs"><i class="fa fa-trash-o " onclick="window.location.href='DeleteAbsence.jsp?id=${e.id_a}'" ></i></button>
					</td>

...
<h1>Ajouter Emplois du temps</h1>
...
<center>
		...
		<table>
			<tr height="1">
              <th >	Enter File Name<input type="text" name="file_name"></th>
              
               </tr >
               <tr height="1">
                 <th>Select<input type="file" name="file2" /></th></tr>
               
               
          </table>
          </div>
          <center><input type="submit"class="btn btn-theme"  value="upload" /></center>
           </form>  

    ...
    <section id="main-content">
      ...
      <table class="table table-striped">
 		 	 <tr>		
					...
					<td>Nom :<input  type ="text" name="fil"></td>
					
					<td align="center"><button class="btn btn-theme" type="submit" value="OK">Ok</button><td>
			</tr>	
		</table>
...
<tr><th>Id</th><th>Name</th><th>Prenom</th><th>Email</th><th>Sex</th><th>Tel</th><th>Num_classe</th><th>Filière</th><th>Edit</th><th>Delete</th></tr>
...
<br/>    <button onclick="window.location.href='AjouterEtudiant.jsp'" class="btn btn-theme" style="width:555px; margin-top:20px;  ">Ajouter Etudiant</button>
 		 </div>
        <!-- /row -->

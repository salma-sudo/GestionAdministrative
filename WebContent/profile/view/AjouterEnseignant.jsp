            ...
            <div class="form-panel">
              <div class="form">
               <div class="card-body">
                  ...
                  <button class="btn btn-theme" onclick="window.location.href='viewusers.jsp'"  style="width:555px; margin-top:20px;margin : auto; ">Afficher Liste des Enseignants</button>
                   </div>                          
                <form class="cmxform form-horizontal style-form" id="signupForm"  method="POST" action="adduser1.jsp">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-lg-offset-2 col-lg-10">
                      ...
                      <button class="btn btn-theme04" type="button" onclick="window.location.href='http://localhost:8080/Enseignant/profile/view/AcueilAdmin.jsp'" >Cancel</button>
                    </div>
                  </div>
                </form>
              </div>

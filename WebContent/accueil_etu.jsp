...
<%
 ...
 <h4><font color="blue">
 Bienvenue ,en tant qu'étudiant cette application vous offres deux services ;</font>
 
 </h4>
 
<p>
1- Vous pouvez consultez vos absences, 
</p> 
<p>2-Vous pouvez consulter votre emplois du temps.</p>

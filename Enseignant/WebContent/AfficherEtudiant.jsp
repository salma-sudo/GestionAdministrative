...
<head>
 ...
 <link href="img3/favicon.png" rel="icon">
  ...
  <!--external css-->
  <link href="lib/font-awesome/css3/font-awesome.css" rel="stylesheet" />
...
<section id="container">
   ...
   <!--main content start-->
    <section id="main-content">
      <section class="wrapper">
      	 <h3><i class="fa fa-angle-right"></i> Afficher la liste des étudiants </h3>
			<form action="FaireAbsence" method="post" onSubmit="return validateForm()" name="frm" >
			...
			Entrer le nom de la Matière :<input type ="text"  class=" form-control"  name="matiere">
 ...
 <!--   <script type="text/javascript">
  ...
  function validateForm() { 
	  if(document.frm.asc.value=="") {
		  alert("Il faut préciser l'année scolaire des étudiants et le numéro du groupe"); 
		  document.frm.username.focus();
		  return false;
		 // swal("Opps...," "Il faut entrer un numero de groupe","error");
		  } else if(document.frm.grp.value=="") {
			  alert("Il faut préciser le numéro du groupe");

...
<section id="container">
    ...
    <section id="main-content">
      <section class="wrapper">
        ...
        <!-- row -->
        <h3>Gestion de l'absence</h3>
        <div class="content-panel">
        
        
 		 <form action="AfficherEtudiantAbs"  method="post">
 		 <table class="table table-striped">
 		 	 <tr>		
 		 				
					<td>Filière :<input type ="text" name="fil"></td>
					<td>Groupe:<input type ="text" name="group"><td>
					<td>Année Scolaire : <input type ="text" name="asc"><td>
		...
		<div class="form-group ">
				...
				<c:forEach items="${modele.etudiantAbs}" var="abs" >
				<tr>
					...
					<td><button class="btn btn-danger btn-xs"><i class="fa fa-trash-o " onclick="window.location.href='DeleteAbsence.jsp?id_a=${abs.id_a}'" ></i></button>
					</td>

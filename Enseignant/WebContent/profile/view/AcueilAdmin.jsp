...
<section id="container">
   ...
   <!--main content start-->
    <section id="main-content">
      <section class="wrapper">
        <h2><i class="fa fa-angle-right"></i>Présentation générale de vos fonctionnalités </h2>
 ...
 <h4><font color="blue">
 Bienvenue ,en tant qu'administrateur cette application vous offres plusieurs services ;</font>
 
 </h4>
 
<p>
1- La gestion des enseignants ce qui implique l'ajout, modification et suppression des enseignants de votre établissement ainsi que le traitement des demandes de congé, 
</p> 
<p>2-La gestion des étudiants comporte de même l'ajout, modification et suppression des étudiants, comme elle vous donne la permission de modifier les listes d'absences.</p>
<p>3-L'ajout des emplois du temps pour les étudiants et les horaires de travail pour les enseignants.</p>
 </div>
          <!-- /row -->
        <!-- FORM VALIDATION -->

    ...
    <section id="main-content">
      <section class="wrapper">
        ...
        <!-- row -->
 		 <div class="row mt">
          <div class="col-lg-12">
            <h4><i class="fa fa-angle-right"></i> Ajouter étudiant</h4>
            <div class="form-panel">
              <div class="form">
               <div class="card-body">
                ...
                <form class="cmxform form-horizontal style-form"   method="POST" action="adduser.jsp">
                  ...
                  <div class="form-group ">
                    ...
                    <div class="col-lg-10">
                      <input class="form-control " id="password" name="Filiere" type="text" />
                    </div>
                  </div>
                  ...
                  <div class="form-group ">
                   ...
                   <div class="form-group ">
                    ...
                    <div class="col-lg-10">
                      <input class="form-control " id="email" name="tel" type="text" />
                    </div>
                  </div>
                  <div class="form-group ">

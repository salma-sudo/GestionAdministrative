...
<button onclick="window.location.href='adduserform1.jsp'" class="btn btn-success" style="width:200px;  margin-top:100px; margin-left:100px;">Ajouter Employer</button>
<button onclick="window.location.href='viewusers1.jsp'" class="btn btn-success" style="width:200px;  margin-top:100px; margin-left:130px;">Afficher liste des Employers</button>

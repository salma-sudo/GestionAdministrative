    ...
    <section id="main-content">
      <section class="wrapper">
        ...
        <!-- row -->
 		 <div class="row mt">
          <div class="col-lg-12">
            <h4><i class="fa fa-angle-right"></i> Modifier étudiant</h4>
            <div class="form-panel">
              <div class="form">
               <div class="card-body">
                  <div class="form-group ">
                  <button class="btn btn-theme" onclick="window.location.href='ListeEtudiant.jsp'"  style="width:555px; margin-top:20px;margin : auto; ">Afficher Liste des Etudiants</button>
                   </div>                          
               <form action="edituser.jsp" method="post">
                  ...
                  <div class="form-group ">
                    ...
                    <div class="col-lg-10">
                      <input class=" form-control" id="firstname" name="nom" type="text" value="<%=u.getNom()%>"/>
                    </div>
                  </div>
                  <div class="form-group ">
                    <label for="lastname" class="control-label col-lg-2">Prénom</label>
                    <div class="col-lg-10">
                      <input class=" form-control" id="lastname" name="prenom" type="text" value="<%=u.getPrenom()%>" />
                    </div>
                  </div>
                  ...
                  <div class="form-group ">
                    ...
                    <div class="col-lg-10">
                      <input class="form-control " id="password" name="password" type="text" value="<%=u.getPassword()%>" />
                    </div>
                  </div>
                  <div class="form-group ">
                    <label for="password" class="control-label col-lg-2">Filiere</label>
                    <div class="col-lg-10">
                      <input class="form-control " id="password" name="Filiere" type="text" value="<%=u.getFiliere()%>" />
                    </div>
                  </div>
                  ...
                  <div class="form-group ">
                            ...
                            <label for="curl" class="control-label col-lg-2">Année scolaire</label>
                            <div class="col-lg-10">
                           
                                    <div class="rs-select2 js-select-simple select--no-search">
                                        <select name="A_scolaire"  class="form-control">
                  ...
                  <div class="form-group ">
                            ...
                            <label for="curl" class="control-label col-lg-2">Num de classe </label>
                 ...
                 <!-- <div class="form-group ">
                    <label for="curl" class="control-label col-lg-2">Filière</label>
                            <div class="col-lg-10">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-lg-offset-2 col-lg-10">
                      <button class="btn btn-theme" type="submit" value="Ajouter Etudiant">Save</button>

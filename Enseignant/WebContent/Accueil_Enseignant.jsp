...
<%
 ...
 <h4><font color="blue">
 Bienvenue ,en tant qu'enseignant cette application vous offres plusieurs services ;</font>
 
 </h4>
 
<p>
1- Vous pouvez consultez vos pointages, 
</p> 
<p>2-La gestion des absences des étudiant par filière et Num de groupe et année scolaire de la classe .</p>
<p>3-Vous pouvez faire des demandes de congé et consulter vos demandes accepter par l'administration .</p>
 </div>
